...
analyser_pipeline = pipeline('sentiment-analysis')
# analyser_pipeline = lambda x: x
class sentiment:
    analyser: Callable = None
    
    def __init__(self) -> None:
        self.analyser = analyser_pipeline
...
class forecast:
    def forecast(score: float, array, tag: bool = True) -> float:
        return predict.predict(score, array, tag)